...
describe('CustomerDetails e2e test', () => {
  ...
  // const customerDetailsSample = {"gender":"MALE","phone":"(858) 672-2084 x375","addressLine1":"squash supposing","city":"Bethesda","country":"Moldova"};
  ...
  describe('new CustomerDetails page', () => {
    ...
    it.skip('should create an instance of CustomerDetails', () => {
      ...
      cy.get(`[data-cy="phone"]`).type('397.431.7978 x304');
      cy.get(`[data-cy="phone"]`).should('have.value', '397.431.7978 x304');

      cy.get(`[data-cy="addressLine1"]`).type('amber');
      cy.get(`[data-cy="addressLine1"]`).should('have.value', 'amber');

      cy.get(`[data-cy="addressLine2"]`).type('above');
      cy.get(`[data-cy="addressLine2"]`).should('have.value', 'above');

      cy.get(`[data-cy="city"]`).type('South Clairfield');
      cy.get(`[data-cy="city"]`).should('have.value', 'South Clairfield');

      cy.get(`[data-cy="country"]`).type('Turkmenistan');
      cy.get(`[data-cy="country"]`).should('have.value', 'Turkmenistan');
