...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'without if' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('frizz hound');
      cy.get(`[data-cy="name"]`).should('have.value', 'frizz hound');

      cy.get(`[data-cy="description"]`).type('communist psst');
      cy.get(`[data-cy="description"]`).should('have.value', 'communist psst');
