...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'for lecture', price: 10724.67, productSize: 'XXL' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'under variability', description: 'clinking ack irresponsible' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="description"]`).type('toward statement');
      cy.get(`[data-cy="description"]`).should('have.value', 'toward statement');

      cy.get(`[data-cy="price"]`).type('9057.18');
      cy.get(`[data-cy="price"]`).should('have.value', '9057.18');
